...
public class ComplaintService {
    ...
    public List<ComplaintsV1> findByHostelIdAndCustomerId(String hostelId, String customerId) {
        return complaintsRepository.findByHostelIdAndCustomerId(hostelId, customerId);
    }
}
